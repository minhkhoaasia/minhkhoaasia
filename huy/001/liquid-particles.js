...
(function(){
	...
	function init(){
		...
		if ( canvas.getContext ){
			setup();
			setInterval( run , 33 );
			trace('<b>Huy|Unbreakable</b><br />Bé yêu nghịch một lúc rồi nhập mật khẩu để xem món quà kế tiếp nha!^^ <br /><a href="http://phuthuynho1.byethost5.com/"><b> </b></a>');
		}
		else{
